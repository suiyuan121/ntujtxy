...
<body>
					...
					<li>
						...
						<a class="emng-select">
							...
							<select onchange="change($(this))" name="type" class="loc">
								<option value="one"
									${(prizeInfoForm.type eq 'one')?"selected='selected'":''}>一等奖</option>
								<option value="two"
									${(prizeInfoForm.type eq 'two')?"selected='selected'":''}>二等奖</option>
								<option value="three"
									${(prizeInfoForm.type eq 'three')?"selected='selected'":''}>三等奖</option>
								<option value="luck"
									${(prizeInfoForm.type eq 'luck')?"selected='selected'":''}>幸运奖</option>
							</select>
						</a>
					</li>
				</ul>
	...
	<div class="pagebtn-wrapper emng-flex">
		<div class="btn-wrap emng-flex">
			<a href="stuAdd.htm" id="user-buttonNew" class="emng-btn btn-bg-gray"
